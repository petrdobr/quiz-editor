 ...
 */
class getAssignmentApiControllerService extends App_KernelDevDebugContainer
{
    /**
     * Gets the public 'App\Controller\AssignmentApiController' shared autowired service.
     *
     * @return \App\Controller\AssignmentApiController
     */
    public static function do($container, $lazyLoad = true)
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/AssignmentApiController.php';

        $container->services['App\\Controller\\AssignmentApiController'] = $instance = new \App\Controller\AssignmentApiController();
        ...
        ]))->withContext('App\\Controller\\AssignmentApiController', $container));
