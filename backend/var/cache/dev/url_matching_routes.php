...
return [
    ...
    [ // $staticRoutes
        '/api/assignments' => [
            [['_route' => 'app_assignmentapi_list', '_controller' => 'App\\Controller\\AssignmentApiController::list'], null, ['GET' => 0], null, false, false, null],
            [['_route' => 'app_assignmentapi_create', '_controller' => 'App\\Controller\\AssignmentApiController::create'], null, ['POST' => 0], null, false, false, null],
        ],
    ],
    [ // $regexpList
        0 => '{^(?'
    ...
    [ // $dynamicRoutes
        ...
        289 => [
            [['_route' => 'app_assignmentapi_getone', '_controller' => 'App\\Controller\\AssignmentApiController::getOne'], ['id'], ['GET' => 0], null, false, true, null],
            [['_route' => 'app_assignmentapi_update', '_controller' => 'App\\Controller\\AssignmentApiController::update'], ['id'], ['PUT' => 0], null, false, true, null],
            [['_route' => 'app_assignmentapi_delete', '_controller' => 'App\\Controller\\AssignmentApiController::delete'], ['id'], ['DELETE' => 0], null, false, true, null],
        ],
        328 => [
